...
<div align="center">
  ...
  <p><img src="./docs/assets/readme/hero-chat-en.gif" alt="Codeksei gently checking in with warm English chat bubbles." width="720"></p>
  <p><em>Checks in gently, remembers where you paused, and helps you ease back in.</em></p>
  <h3>A local-first companion that helps time hold shape and brings daily life and project threads back within reach</h3>
  <p><strong>It keeps timeline, diary, reminders, reviews, and project continuity inside one local-first companion core, then lets different host bridges attach to it.</strong></p>
  <p>Codeksei is not just a prompt box, and it is not a second agent runtime. It can leave a note, reconnect a loose thread, or hold a reminder for you before you have to rebuild everything from fog. WeChat is now only a first-party adapter, not the whole product identity.</p>
  <p>
