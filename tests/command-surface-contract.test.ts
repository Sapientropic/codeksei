...
test("package scripts keep runtime entrypoints aligned with the published-runtime contract", () => {
  ...
  const expectedScripts: Record<string, string> = {
    ...
    "capabilities:status": buildNodeRuntimeInvocation("cli", ["capabilities", "status"]),
    ...
    "context:inspect": buildNodeRuntimeInvocation("cli", ["context", "inspect"]),
    ...
    "pulse:today": buildNodeRuntimeInvocation("cli", ["pulse", "today"]),
    "pulse:generate": buildNodeRuntimeInvocation("cli", ["pulse", "generate"]),
    "pulse:feedback": buildNodeRuntimeInvocation("cli", ["pulse", "feedback"]),
