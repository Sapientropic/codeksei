...
export const COMMAND_SAFETY_OVERRIDES = {
  ...
  "operator.help": "operator",
  "operator.schema": "operator",
  "proactive.observe": "warned",
  "pulse.feedback": "warned",
  "pulse.generate": "warned",
  "pulse.today": "warned",
  "project.radar": "open",
...
export const COMMAND_MUTABILITY_OVERRIDES = {
  ...
  "proactive.eval": "read",
  "proactive.observe": "write",
  "pulse.feedback": "write",
  "pulse.generate": "write",
  "pulse.today": "write",
  "project.radar": "read",
