...
export const COMMAND_ACTION_DEFINITIONS = [
  ...
  },
  {
    ...
    subcommand: "build",
    runner: "timeline.subcommand",
    help: { topic: "timeline", leafKey: "timeline.build", detail: "topic_only" },
  ...
  },
  {
    ...
    subcommand: "serve",
    runner: "timeline.subcommand",
    help: { topic: "timeline", leafKey: "timeline.serve", detail: "topic_only" },
  ...
  },
  {
    ...
    subcommand: "dev",
    runner: "timeline.subcommand",
    help: { topic: "timeline", leafKey: "timeline.dev", detail: "topic_only" },
