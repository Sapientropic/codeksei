...
const ACTION_USAGE_ARGS: Readonly<Partial<Record<CommandActionId, string>>> = Object.freeze({
  ...
  "host.settle_checkin": '--provider hermes --user <wechat_user_id> --workspace /绝对路径 --lease <leaseId> --result sent_message|silent|backstage_only|failed [--create-handoff --message "..." --observed-state "..."] [--bookkeeping-action "timeline|done|..."] [--decision-id <id> --response-outcome ignored --feedback-text "..."] [--next-wake-at <ISO8601> | --sleep-for ' + CHECKIN_COMPLETION_SLEEP_FOR_PLACEHOLDER + "]",
