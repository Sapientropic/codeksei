...
export function renderHermesCompanionSkill(): string {
  const lines = [
    ...
    buildTerminalActionExample("companion.remember", { audience: "public", includeArgs: true }),
    buildTerminalActionExample("note.auto", { audience: "public", includeArgs: true }),
    buildTerminalActionExample("onboarding.start", { audience: "public", includeArgs: true }),
    buildTerminalActionExample("onboarding.step", { audience: "public", includeArgs: true }),
    buildTerminalActionExample("onboarding.status", { audience: "public", includeArgs: true }),
    ...
    `${buildTerminalEntryUsage("context.inspect", "public")} --user <wechatUserId> --workspace /absolute/workspace --mode proactive`,
    `${buildTerminalEntryUsage("capabilities.status", "public")} --provider hermes --user <wechatUserId> --workspace /absolute/workspace`,
    `${buildTerminalEntryUsage("pulse.today", "public")} --user <wechatUserId> --workspace /absolute/workspace`,
    `${buildTerminalEntryUsage("pulse.generate", "public")} --user <wechatUserId> --workspace /absolute/workspace --focus "..."`,
    `${buildTerminalEntryUsage("pulse.feedback", "public")} --kind like|dislike|hide|save|task --card <pulseCardId> --topic "..."`,
    ...
    `${buildTerminalEntryUsage("host.settle_checkin", "public")} --provider hermes --user <wechatUserId> --workspace /absolute/workspace --lease <leaseId> --result sent_message --create-handoff --message "..." --observed-state "..." --followup-context "..." --bookkeeping-action "timeline|done|..."`,
    `${buildTerminalEntryUsage("host.finalize_checkin", "public")} --provider hermes --user <wechatUserId> --workspace /absolute/workspace --lease <leaseId> --sleep-for 2h`,
    "```",
    "",
    "## Default Routing",
    "",
    ...
    `${buildTerminalEntryUsage("host.seed_proactive", "public")} --provider hermes --user <wechatUserId> --workspace /absolute/workspace`,
    `${buildTerminalEntryUsage("host.claim_checkin", "public")} --provider hermes --user <wechatUserId> --workspace /absolute/workspace`,
    `${buildTerminalEntryUsage("host.settle_checkin", "public")} --provider hermes --user <wechatUserId> --workspace /absolute/workspace --lease <leaseId> --result silent --create-handoff --observed-state "..." --followup-context "..."`,
    `${buildTerminalEntryUsage("host.finalize_checkin", "public")} --provider hermes --user <wechatUserId> --workspace /absolute/workspace --lease <leaseId> --sleep-for 2h`,
    "```",
    "",
    "Flow:",
