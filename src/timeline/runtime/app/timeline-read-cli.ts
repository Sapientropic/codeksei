...
interface TimelineReadCliOptions {
  help: boolean;
  date: string;
}

async function runTimelineReadCommand(config: TimelineRuntimeConfig): Promise<void> {
...
function parseArgs(args: string[]): TimelineReadCliOptions {
  const options: TimelineReadCliOptions = {
    help: false,
    date: "",
  };
