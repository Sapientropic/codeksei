...
import type { TimelineDashboardData, TimelineRangeKey } from "../../contracts";
import { AnalyticsPanels, HeaderStats } from "./DashboardSections";
...
interface TabBarProps {
  ...
  onChange: (value: TimelineRangeKey) => void;
  items: Array<{ id: TimelineRangeKey; label: string }>;
}
...
function TabBar({ value, onChange, items }: TabBarProps): JSX.Element {
  return (
